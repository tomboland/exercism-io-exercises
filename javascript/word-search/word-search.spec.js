...
const rightward = (x, y, len) => [x + len, y]
const leftward = (x, y, len) => [x - len, y]
const downward = (x, y, len) => [x, y + len]
const upward = (x, y, len) => [x, y - len]
const diag_right_down = compose(rightward, downward)
const diag_right_up = compose(rightward, upward)
const diag_left_down = compose(leftward, downward)
const diag_left_uu = compose(leftward, upward)
